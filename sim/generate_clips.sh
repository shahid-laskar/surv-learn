#!/usr/bin/env bash
# sim/generate_clips.sh
# Generate 3 sample video clips (one per simulated site), each 60s, 480p H.264.
# Burns a visible site label (SITE-01, SITE-02, SITE-03) plus a timestamp.
# Output: sim/clips/site-01.mp4, site-02.mp4, site-03.mp4
#
